...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_ACTION_TABLE = "CREATE TABLE " + TABLE_ACTIONS + "(" + KEY_AID + " INTEGER PRIMARY KEY," + KEY_UID + " INTEGER NOT NULL," + KEY_PID + " INTEGER NOT NULL"
                + "FOREIGN KEY(" + KEY_UID + ") REFERENCES " + TABLE_USERS + "(" + KEY_UID + "), FOREIGN KEY (" + KEY_UID + ") REFERENCES " + TABLE_USERS + "(" + KEY_PID +
                ")";
